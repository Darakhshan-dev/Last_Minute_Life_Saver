...
export default function SignIn() {
  const { signInWithGoogle, signInAnonymously, loading: authLoading } = useAuth();
        ...
        {isIframe && (
          <div className="mb-6 p-3 bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 text-xs rounded-xl flex items-start gap-2.5 leading-relaxed">
            ...
            <div>
              ...
              <p className="text-indigo-200/80 text-[11px]">If Google login popups are blocked or cancelled, click the <span className="font-semibold text-white">"Open in new tab"</span> button at the top right of this preview pane to sign in seamlessly!</p>
            </div>
          </div>
        )}
